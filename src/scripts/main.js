...
const produtos = [
    {
        id: 1,
        nome: 'Pac Pikachu',
        img: '../img/blusas/pikachu.png',
        valor: 40.00
    },
    {
        id: 2,
        nome: 'Alerquina e Coringa',
        img: '../img/blusas/aleCor.png',
        valor: 40.00
    },
    {
        id: 3,
        nome: 'Capitão América',
        img: '../img/blusas/capAmerica.png',
        valor: 40.00
    },
]
...
function send(){
    ...
    const fields = {
        ...
        size: document.querySelector('select#size').value,
...
function formatedText(fields){
    var text = `*Produto*: ${fields.name}  *Tamanho*:${fields.size}  *Preço*:${fields.price}  
